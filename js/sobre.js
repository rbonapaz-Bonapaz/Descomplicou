...
export const NOVIDADES_ARQUIVADAS = [
  ...
  { versao: 'v100', itens: [
    ...
    'Novo campo "Como deseja ser chamado(a)?" no cadastro de cliente e no link de evento — todas as mensagens de WhatsApp do sistema passam a usar esse apelido quando cadastrado (ex: "Ana Paula Souza – Ana" vira só "Ana" na mensagem); sem apelido, usa o nome completo como sempre.',
