...
export const state = {
  user: null,
  profile: null,
  filters: { prod: 'todos', estoque: 'todos', rel: '30', vendas: 'todos', prodSort: 'nome_asc', estoqueSort: 'nome_asc', vendasSort: '', prodLinha: '', relProdSort: '', estoqueLinha: '', clientesSort: 'nome_asc', carrinhoItensSort: '', semLucroMotivo: '', preEncomendaSort: 'nome_asc' },
